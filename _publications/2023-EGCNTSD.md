...
excerpt: 'An explainable GCN using frequency-domain embedding and attention mechanism to study brain functional connectivity development, revealing the transition from segregated to integrated brain networks.'
# pubinfo: 
revinfo: Revision.
---
